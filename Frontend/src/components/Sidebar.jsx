  ...
  return (
    ...
    >
      <div className=" bg-transparent lg:shadow-lg border-b-gray-200 lg:mt-5  ">
        ...
        <div className="lg:flex lg:text-lg">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-4 text-blue-700 lg:mt-2 lg:ml-4"
          >
            <path
              strokeLinecap="round"
          ...
          <p className="ml-2">Let's crush some tasks!</p>
        </div>
      </div>
      ...
      <div className="lg:mt-45">
        ...
        >
          ...
          <h1 className="lg:text-lg">Settings</h1>
        </div>
