...
export default function Register() {
  ...
  return (
    <div className="lg:h-140 h-104 w-full mt-20 lg:flex md:flex justify-center lg:mt-25 md:mt-60 md:h-100   ">
      <ToastContainer position="bottom-left" autoClose={3000} />
      <div
        className=" bg-[#1082ff] text-[#dffeff] ml-2.5 rounded-t-2xl h-35 w-86 lg:h-full lg:w-[25%] lg:rounded-tl-3xl
      lg:border-2 border-sky-300 lg:rounded-bl-3xl lg:shadow-[0_10px_20px_-7px_rgba(0,0,0,0.6)]
      md:w-[30%] md:h-full md:rounded-tl-2xl md:border-2 md:rounded-bl-2xl md:shadow-[0_10px_20px_-8px_rgba(0,0,0,0.4)]"
      >
        <h1
        ...
        <div className="flex mt-10 ml-24 gap-10 lg:gap-15 lg:ml-14 lg:mt-8 md:gap-7 md:ml-4.5 md:mt-5">
          <button
            onClick={() => setFormState(0)}
            className={`${
              formState === 0
                ? "px-1 py-1.5 lg:px-5 lg:py-2.5 rounded-md border-2 border-sky-300 bg-white text-[#2563eb] transition-transform duration-500 hover:scale-107  lg:hover:bg-blue-50 md:px-4 md:py-2"
                : "px-1 py-1.5 lg:px-5 lg:py-2.5 rounded-md border border-white text-white bg-transparent lg:hover:bg-white/10 transition-transform duration-500 hover:scale-107 md:px-4 md:py-2"
            }`}
          >
            Register
          </button>
      ...
      <div
        className="w-[95%] h-full ml-3 lg:ml-0 md:ml-0 rounded-md border lg:w-[40%] lg:rounded-tr-3xl lg:rounded-br-3xl lg:border-2
      ...
      >
        ...
        <div
          className="border mt-6 w-[93%] h-[66%] ml-3 rounded-sm border-slate-400  lg:ml-20 lg:w-[75%] lg:h-[48%] 
        ...
        >
          ...
          >
            ...
            <div className="relative left-0 lg:top-0 lg:left-0 mt-5 gap-30 ml-5 text-40 lg:ml-0 lg:mt-10 lg:text-70  md:text-60 md:mt-6  md:ml-0">
              <button
