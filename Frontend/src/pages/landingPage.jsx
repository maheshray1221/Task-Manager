...
export default function LandingPage() {
  ...
  //framer-motion(staggerChildren) -> for animation
  const container = {
    hidden: {},
    show: {
      transition: {
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: false }}
          transition={{ duration: 0.9, ease: "easeOut" }}
          className="w-full ml-3.5 mt-3 md:text-center md:mt-4  lg:text-center lg:mt-4 text-slate-600"
        >
         ...
         md:w-150 md:h-65 md:ml-28 md:mt-20 md:transition-transform md:duration-500 md:hover:scale-105 md:shadow-[0_10px_20px_-10px_rgba(0,0,0,0.4)]"
          >
            ...
            <div className="text-lg ml-13 mt-3 w-[80%] md:text-[lg] md:w-[80%] md:ml-20 md:mt-6 text-slate-600">
              <p>
                Add members to projects, assign tasks, and collaborate
        ...
        md:w-150 md:h-65 md:ml-28 md:mt-20 md:transition-transform md:duration-500 md:hover:scale-105 md:shadow-[0_10px_20px_-10px_rgba(0,0,0,0.4)]"
          >
            ...
            <div className="text-lg ml-12 mt-3 w-[80%] md:text-[lg] md:ml-20 md:mt-6 lg:ml-15 text-slate-600">
              <p>
                Break tasks into sub-tasks to manage work in a more organized
                and structured way.
              </p>
            </div>
          </motion.div>
        </motion.div>
        <div className="mt-10 shadow-xl md:mt-18 lg:mt-25 transition-transform duration-500 hover:scale-105 lg:shadow-2xl g:shadow-[0_10px_20px_-10px_rgba(0,0,0,1)]">
          <img src="/protask.png" alt="taskManager" />
        </div>
        <motion.button
          initial={{ y: 0, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
